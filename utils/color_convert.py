...
#from: http://aspn.activestate.com/ASPN/Cookbook/Python/Recipe/266466
...
def HexColorToRGB(pil_color):
    """ convert a hex-compatible integer into an (r, g, b) tuple """
    hexstr = '%06x' % pil_color
    # reverse byte order
    r, g, b = hexstr[:2], hexstr[2:4], hexstr[4:]
    r, g, b = [int(n, 16) for n in (r, g, b)]
    return (r, g, b)
